...
class News {
    ...
    public static function add(array $params)
    {
        ...
        $req = $db->prepare("INSERT INTO articles (". implode(',', $keys) .") VALUES (". implode(',', $values) .")");
        $req->setFetchMode(PDO::FETCH_ASSOC);
    ...
    public static function update(array $uniqueKey, array $values)
    {
        ...
        $req = $db->prepare("UPDATE articles SET " . implode(',', $updateValue) . " WHERE " . implode(',', $updateCondition)  );
