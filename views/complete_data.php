            ...
            <form method="post">
                ...
                <div id="complete_data_presentation">
                    ...
                    <div id="person_infos">
                        ...
                        <input type="date" id="birth_day" name="birth_day" value="<?php if (isset($_POST['birth_day']) && !empty($_POST['birth_day']) ) { echo $_POST['birth_day'][0].$_POST['birth_day'][1].$_POST['birth_day'][2].$_POST['birth_day'][3]."-".$_POST['birth_day'][5].$_POST['birth_day'][6]."-".$_POST['birth_day'][8].$_POST['birth_day'][9]; } else if (isset($user[0]['birth_day'])) { echo $user[0]['birth_day'][0].$user[0]['birth_day'][1].$user[0]['birth_day'][2].$user[0]['birth_day'][3]."-".$user[0]['birth_day'][5].$user[0]['birth_day'][6]."-".$user[0]['birth_day'][8].$user[0]['birth_day'][9];}?>">
