...
<main>
    ...
    <section id="news">
        ...
        <div class="scrollable">
            ...
            <?php foreach (["", "", "" ,""] as $item): ?>
                <div class="news">
                    <img src="/img/NBA-stephen-curry-760x395 1.png" alt="picture of stephen curry"/>
                    <div>
                        <h3 class="title">Le nouvel espoir de la NBA a un nom et il s'appelle Clausius</h3>
                        <h4 class="date">posté le 04/20/21</h4>
